...
function Index(){
              ...
              >
                <ul className="navigation clearfix">
                  ...
                  <li className="current dropdown">
                    ...
                    <ul>
                      <li>
                        <a href="/Page1">Product Development</a>
                      </li>
                      <li>
                        <a href="/Page2">Regulatory</a>
                      </li>
                      <li>
                        <a href="/Page3">GMP Compilance and Assessment</a>
                      </li>
                      <li>
                        <a href="/Page4">Product Lifecycle Management</a>
                      </li>
                    </ul>
                  </li>
                  <li>
  ...
  <div className="outer-container">
    ...
    >
      ...
      >
        Click here to explore collaborations
      </a>
    </div>
  </div>
</section>
          ...
          <div className="tab-btn-box p_relative mb_110">
            <ul className="tab-btns tab-buttons clearfix">
              ...
              <li className= "tab-btn" data-tab="#tab-3">
                <Link href="/Page3" >
                GMP Compilance and Assessments
                </Link>
              </li>
